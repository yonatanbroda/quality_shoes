...
<body>
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="{{ route('home') }}" class="logo">
                                <img src="{{ asset('img/icono.png') }}" alt="QualityStore" width="70px">
                                QualityStore&#174;
                            </a>
                        </div>
    ...
    <center>
        <br>
        <h2>GRUPO 4</h2>
        </h5>Materia:Sistema de Información</h5>
        <div class="container">
            <img class="circle2" src="{{ asset('img/logo.jpg') }}" />Luishiño
            <img class="circle2" src="{{ asset('img/logo.jpg') }}" />Karla
            <img class="circle2" src="{{ asset('img/logo.jpg') }}" />Erick
            <img class="circle2" src="{{ asset('img/logo.jpg') }}" />Jose Luis
            <img class="circle2" src="{{ asset('img/logo.jpg') }}" />Ericka
    ...
    <div class="section">
        ...
        <footer id="footer">
            <div id="paginacion">
                <span class="izquierda" type="button" onclick="history.back()"
                    name="boton-personalizado-2"><a>&laquo;
                        Anterior </a></span>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <div class="fb-page"
                                    data-href="https://www.facebook.com/Quality-Store-1999078610372910"
                                ...
                                <ul class="footer-links">
                                    ...
                                    <div class="footer-social">
                                        <a target="_blank"
                                            href="https://www.facebook.com/Quality-Store-1999078610372910"><i
                            ...
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                    ...
                                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                                        ...
                                        <img alt="" border="0" src="https://www.paypal.com/en_BO/i/scr/pixel.gif"
                                            width="1" height="1" />
                                    </form>
                                </ul>
                            </div>
